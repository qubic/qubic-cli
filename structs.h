...
enum COMMAND
{
    ...
    NOSTROMO_REGISTER_IN_TIER = 110,
    NOSTROMO_LOGOUT_FROM_TIER = 111,
    NOSTROMO_CREATE_PROJECT = 112,
    NOSTROMO_VOTE_IN_PROJECT = 113,
    NOSTROMO_CREATE_FUNDARAISING = 114,
    NOSTROMO_INVEST_IN_FUNDARAISING = 115,
    NOSTROMO_CLAIM_TOKEN = 116,
    NOSTROMO_GET_STATS = 117,
    NOSTROMO_GET_TIER_LEVEL_BY_USER = 118,
    NOSTROMO_GET_USER_VOTE_STATUS = 119,
    NOSTROMO_CHECK_TOKEN_CREATABILITY = 120,
    NOSTROMO_GET_NUMBER_OF_INVESTED_PROJECTS = 121,
    NOSTROMO_GET_PROJECT_BY_INDEX = 122,
    NOSTROMO_GET_FUNDARAISING_BY_INDEX = 123,
    NOSTROMO_GET_PROJECT_INDEX_LIST_BY_CREATOR = 124,
    NOSTROMO_UPGRADE_TIER_LEVEL = 125,
    NOSTROMO_TRANSFER_SHARE_MANAGEMENT_RIGHTS = 126,
    NOSTROMO_GET_INFO_USER_INVESTED = 127,
    NOSTROMO_GET_MAX_CLAIM_AMOUNT = 128,

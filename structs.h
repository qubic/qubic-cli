...
enum COMMAND
{
    ...
    MSVAULT_REGISTER_VAULT_CMD = 86,
    MSVAULT_DEPOSIT_CMD = 87,
    MSVAULT_RELEASE_TO_CMD = 88,
    MSVAULT_RESET_RELEASE_CMD = 89,
    MSVAULT_GET_VAULTS_CMD = 90,
    MSVAULT_GET_RELEASE_STATUS_CMD = 91,
    MSVAULT_GET_BALANCE_OF_CMD = 92,
    MSVAULT_GET_VAULT_NAME_CMD = 93,
    MSVAULT_GET_REVENUE_INFO_CMD = 94,
    MSVAULT_GET_FEES_CMD = 95,

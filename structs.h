...
enum COMMAND
{
    ...
    NOSTROMO_REGISTER_IN_TIER = 117,
    NOSTROMO_LOGOUT_FROM_TIER = 118,
    NOSTROMO_CREATE_PROJECT = 119,
    NOSTROMO_VOTE_IN_PROJECT = 120,
    NOSTROMO_CREATE_FUNDARAISING = 121,
    NOSTROMO_INVEST_IN_FUNDARAISING = 122,
    NOSTROMO_CLAIM_TOKEN = 123,
    NOSTROMO_GET_STATS = 124,
    NOSTROMO_GET_TIER_LEVEL_BY_USER = 125,
    NOSTROMO_GET_USER_VOTE_STATUS = 126,
    NOSTROMO_CHECK_TOKEN_CREATABILITY = 127,
    NOSTROMO_GET_NUMBER_OF_INVESTED_PROJECTS = 128,
    NOSTROMO_GET_PROJECT_BY_INDEX = 129,
    NOSTROMO_GET_FUNDARAISING_BY_INDEX = 130,
    NOSTROMO_GET_PROJECT_INDEX_LIST_BY_CREATOR = 131,
    NOSTROMO_UPGRADE_TIER_LEVEL = 132,
    NOSTROMO_TRANSFER_SHARE_MANAGEMENT_RIGHTS = 133,
    NOSTROMO_GET_INFO_USER_INVESTED = 134,
    NOSTROMO_GET_MAX_CLAIM_AMOUNT = 135,

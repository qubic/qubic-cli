...
enum COMMAND
{
    ...
    COMP_CHAT = 106,
    QVAULT_COMMAND_GETDATA = 107,
    QVAULT_COMMAND_GET_STAKED_AMOUNT_AND_VOTING_POWER = 108,
    QVAULT_COMMAND_GET_GP = 109,
    QVAULT_COMMAND_GET_QCP = 110,
    QVAULT_COMMAND_GET_IPOP = 111,
    QVAULT_COMMAND_GET_QEARNP = 112,
    QVAULT_COMMAND_GET_FUNDP = 113,
    QVAULT_COMMAND_GET_MKTP = 114,
    QVAULT_COMMAND_GET_ALLOP = 115,
    QVAULT_COMMAND_GET_MSP = 116,
    QVAULT_COMMAND_GET_IDENTITIES_HV_VT_PW = 117,
    QVAULT_COMMAND_GET_PP_CREATION_POWER = 118,
    QVAULT_COMMAND_GET_QCAP_BURNT_AMOUNT_IN_LAST_EPOCHES = 119,
    QVAULT_COMMAND_GET_AMOUNT_TO_BE_SOLD_PER_YEAR = 120,
    QVAULT_COMMAND_GET_TOTAL_REVENUE_IN_QCAP = 121,
    QVAULT_COMMAND_GET_REVENUE_IN_QCAP_PER_EPOCH = 122,
    QVAULT_COMMAND_GET_REVENUE_PER_SHARE = 123,
    QVAULT_COMMAND_GET_AMOUNT_OF_SHARE_QVAULT_HOLD = 124,
    QVAULT_COMMAND_GET_NUMBER_OF_HOLDER_AND_AVG_AM = 125,
    QVAULT_COMMAND_GET_AMOUNT_FOR_QEARN_IN_UPCOMING_EPOCH = 126,
    QVAULT_COMMAND_STAKE = 127,
    QVAULT_COMMAND_UNSTAKE = 128,
    QVAULT_COMMAND_SUBMIT_GP = 129,
    QVAULT_COMMAND_SUBMIT_QCP = 130,
    QVAULT_COMMAND_SUBMIT_IPOP = 131,
    QVAULT_COMMAND_SUBMIT_QEARNP = 132,
    QVAULT_COMMAND_SUBMIT_FUNDP = 133,
    QVAULT_COMMAND_SUBMIT_MKTP = 134,
    QVAULT_COMMAND_SUBMIT_ALLOP = 135,
    QVAULT_COMMAND_SUBMIT_MSP = 136,
    QVAULT_COMMAND_VOTE_IN_PROPOSAL = 137,
    QVAULT_COMMAND_BUY_QCAP = 138,
    QVAULT_COMMAND_TRANSFER_SHARE_MANAGEMENT_RIGHTS = 139,
    QVAULT_COMMAND_SUBMIT_MUSLIMID = 140,
    QVAULT_COMMAND_CANCEL_MUSLIMID = 141,

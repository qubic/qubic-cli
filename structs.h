...
enum COMMAND
{
    ...
    QUTIL_PRINT_FEE,
    QUTIL_GET_BALANCES_MANY,
    QUTIL_BURN_QUBIC_FOR_CONTRACT,
    QUTIL_QUERY_FEE_RESERVE,
    QUTIL_TRANSFER_SHARES_TO_MANY_V1,
    QUTIL_TRANSFER_SHARES_MANAGEMENT_RIGHTS,
    PRINT_QSWAP_FEE,
    QSWAP_ISSUE_ASSET,
    ...
    QRWA_DIVIDENDS,
    QRWA_SC_DIVIDENDS,
    QRWA_DONATE_TREASURY,
    QRWA_VOTE_GOV_PARAMS,
    QRWA_SET_POOL_A_ADDR,
    QRWA_SET_POOL_D_ADDR,
    QRWA_DEPOSIT_ASSET,
    QRWA_REVOKE_ASSET_MGMT,
    ESCROW_CREATE_DEAL_CMD ,
    ESCROW_GET_DEALS_CMD,
    ESCROW_ACCEPT_DEAL_CMD,
    ESCROW_MAKE_DEAL_PUBLIC_CMD,
    ESCROW_CANCEL_DEAL_CMD,
    ESCROW_TRANSFER_RIGHTS_CMD,
    ESCROW_GET_FREE_ASSET_CMD,
    WP_STATUS,
    WP_HOLDER_INFO,
    WP_CLAN_MEMBER_INFO,
    WP_SHAREHOLDER_INFO,
    ...
    WP_DEPOSIT_REVENUE,
    WP_ADD_CLAN_MEMBER,
    WP_REMOVE_CLAN_MEMBER,
    WP_SET_CLAN_RANK,
    WP_SET_ADMIN,
    WP_SET_EXCLUDE_ADDRESS,
    WP_STAKE,
    WP_REQUEST_UNSTAKE,
    WP_FINALIZE_UNSTAKE,
    WP_DEPOSIT_STAKING_REWARDS,
    WP_CLAIM_STAKING_REWARDS,
    WP_EXCLUDE_INFO,
    WP_DIST_PREVIEW,

...
enum COMMAND
{
    ...
    QVAULT_COMMAND_GETDATA,
    QVAULT_COMMAND_GET_STAKED_AMOUNT_AND_VOTING_POWER,
    QVAULT_COMMAND_GET_GP,
    QVAULT_COMMAND_GET_QCP,
    QVAULT_COMMAND_GET_IPOP,
    QVAULT_COMMAND_GET_QEARNP,
    QVAULT_COMMAND_GET_FUNDP,
    QVAULT_COMMAND_GET_MKTP,
    QVAULT_COMMAND_GET_ALLOP,
    QVAULT_COMMAND_GET_IDENTITIES_HV_VT_PW,
    QVAULT_COMMAND_GET_PP_CREATION_POWER,
    QVAULT_COMMAND_GET_QCAP_BURNT_AMOUNT_IN_LAST_EPOCHES,
    QVAULT_COMMAND_GET_AMOUNT_TO_BE_SOLD_PER_YEAR,
    QVAULT_COMMAND_GET_TOTAL_REVENUE_IN_QCAP,
    QVAULT_COMMAND_GET_REVENUE_IN_QCAP_PER_EPOCH,
    QVAULT_COMMAND_GET_REVENUE_PER_SHARE,
    QVAULT_COMMAND_GET_AMOUNT_OF_SHARE_QVAULT_HOLD,
    QVAULT_COMMAND_GET_NUMBER_OF_HOLDER_AND_AVG_AM,
    QVAULT_COMMAND_GET_AMOUNT_FOR_QEARN_IN_UPCOMING_EPOCH,
    QVAULT_COMMAND_STAKE,
    QVAULT_COMMAND_UNSTAKE,
    QVAULT_COMMAND_SUBMIT_GP,
    QVAULT_COMMAND_SUBMIT_QCP,
    QVAULT_COMMAND_SUBMIT_IPOP,
    QVAULT_COMMAND_SUBMIT_QEARNP,
    QVAULT_COMMAND_SUBMIT_FUNDP,
    QVAULT_COMMAND_SUBMIT_MKTP,
    QVAULT_COMMAND_SUBMIT_ALLOP,
    QVAULT_COMMAND_VOTE_IN_PROPOSAL,
    QVAULT_COMMAND_BUY_QCAP,
    QVAULT_COMMAND_TRANSFER_SHARE_MANAGEMENT_RIGHTS,
    ...
    GET_ORACLE_QUERY,
    GET_ORACLE_SUBSCRIPTION,
    SEND_ORACLE_QUERY_TX,
    SEND_ORACLE_CONTRACT_TX,

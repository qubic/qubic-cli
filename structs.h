...
enum COMMAND
{
    ...
    QSWAP_ADD_LIQUDITY = 96,
    QSWAP_REMOVE_LIQUDITY = 97,
    QSWAP_GET_LIQUDITY_OF = 98,
    QSWAP_SWAP_EXACT_QU_FOR_ASSET = 99,
    QSWAP_SWAP_QU_FOR_EXACT_ASSET = 100,
    QSWAP_SWAP_EXACT_ASSET_FOR_QU = 101,
    QSWAP_SWAP_ASSET_FOR_EXACT_QU = 102,
    QSWAP_QUOTE = 103,

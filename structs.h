...
enum COMMAND
{
    ...
    MSVAULT_REGISTER_VAULT_CMD = 89,
    MSVAULT_DEPOSIT_CMD = 90,
    MSVAULT_RELEASE_TO_CMD = 91,
    MSVAULT_RESET_RELEASE_CMD = 92,
    MSVAULT_GET_VAULTS_CMD = 93,
    MSVAULT_GET_RELEASE_STATUS_CMD = 94,
    MSVAULT_GET_BALANCE_OF_CMD = 95,
    MSVAULT_GET_VAULT_NAME_CMD = 96,
    MSVAULT_GET_REVENUE_INFO_CMD = 97,
    MSVAULT_GET_FEES_CMD = 98,
    MSVAULT_GET_OWNERS_CMD = 99,

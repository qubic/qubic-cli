...
enum COMMAND
{
    ...
    QUTIL_DISTRIBUTE_QU_TO_SHAREHOLDERS = 149,
    MSVAULT_DEPOSIT_ASSET_CMD = 150,
    MSVAULT_RELEASE_ASSET_TO_CMD = 151,
    MSVAULT_RESET_ASSET_RELEASE_CMD = 152,
    MSVAULT_GET_ASSET_BALANCES_CMD = 153,
    MSVAULT_GET_ASSET_RELEASE_STATUS_CMD = 154,
    MSVAULT_GET_MANAGED_ASSET_BALANCE_CMD = 155,
    MSVAULT_REVOKE_ASSET_RIGHTS_CMD = 156,
    MSVAULT_IS_SHAREHOLDER_CMD = 157,
    MSVAULT_VOTE_FEE_CHANGE_CMD = 158,
    MSVAULT_GET_FEE_VOTES_CMD = 159,
    MSVAULT_GET_FEE_VOTES_OWNER_CMD = 160,
    MSVAULT_GET_FEE_VOTES_SCORE_CMD = 161,
    MSVAULT_GET_UNIQUE_FEE_VOTES_CMD = 162,
    MSVAULT_GET_UNIQUE_FEE_VOTES_RANKING_CMD = 163,
    QBOND_STAKE_CMD = 164,
    QBOND_TRANSFER_CMD = 165,
    QBOND_ADD_ASK_ORDER_CMD = 166,
    QBOND_REMOVE_ASK_ORDER_CMD = 167,
    QBOND_ADD_BID_ORDER_CMD = 168,
    QBOND_REMOVE_BID_ORDER_CMD = 169,
    QBOND_BURN_QU_CMD = 170,
    QBOND_UPDATE_CFA_CMD = 171,
    QBOND_GET_FEES_CMD = 172,
    QBOND_GET_EARNED_FEES_CMD = 173,
    QBOND_GET_EPOCH_INFO_CMD = 174,
    QBOND_GET_ORDERS_CMD = 175,
    QBOND_GET_USER_ORDERS_CMD = 176,
    QBOND_GET_TABLE_CMD = 177,
    QBOND_GET_USER_MBONDS_CMD = 178,
    QBOND_GET_CFA_CMD = 179,
